...
* Merge branch 'release/1.0.10' into develop
 ([890ef84](https://github.com/ralphcrisostomo/gulp-aws-lambda/commit/890ef84))
...
* Releasing v1.0.10
 ([6463ec8](https://github.com/ralphcrisostomo/gulp-aws-lambda/commit/6463ec8))
* Releasing v1.0.2
...
* Removed console.log
 ([ddc2f72](https://github.com/ralphcrisostomo/gulp-aws-lambda/commit/ddc2f72))
* Upated aws to AWS
